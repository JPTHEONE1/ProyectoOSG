...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" >
    ...
    <a href="index3.html" class="brand-link">
      <img src="https://th.bing.com/th?id=OIP.W8f5LIi6Ue9_YUxYOZ7qQQHaHa&w=250&h=250&c=8&rs=1&qlt=90&o=6&pid=3.1&rm=2" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">FIA</span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
      ...
      <button class="boton">Ofertas Laborales</button>
